...
import ReformTrigger, { TextPrompt } from './ReformTrigger';
...
export default function Node({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {/* Node card wrapper - includes reform trigger for impact nodes */}
      <div className="relative">
        ...
        {/* Reform trigger - Element A: Branching Node (on right edge) */}
        {shouldShowReformTrigger && (
          <ReformTrigger
            reform={reform}
            onClick={onShowReform}
            isOpen={isReformOpen}
