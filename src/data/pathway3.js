  ...
  nodes: [
    ...
    },
    {
      ...
      evidence: [
        ...
        {
          quote: 'One early report suggests that AI is helping Brazil\'s courts resolve cases more quickly. Yet if AI advances continuously reduce filling costs and drive up legal outputs, it will grow increasingly difficult for judges to keep pace.',
          source: 'The Paper',
        },
      ],
    },
    ...
    evidence: [
      {
        ...
        source: 'The Paper (case for more judges)',
      },
      {
        ...
        source: 'The Paper (hierarchy of legal work)',
      },
      {
        ...
        source: 'The Paper (training problem)',
      },
      {
        ...
        source: 'The Paper (industry perspective)',
      },
    ],
  },
};
