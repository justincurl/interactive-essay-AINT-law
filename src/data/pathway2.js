export const pathway2 = {
  ...
  reform: {
    ...
    evidence: [
      ...
      {
        quote: 'Arbitration can promote choice by allowing litigants to decide between traditional judicial review and AI-assisted adjudication. A consumer defending against an automated debt collection suit might prefer quick AI resolution over years of waiting, while a defendant facing serious consequences might insist on traditional review by human judges.',
        label: 'Voluntary arbitration',
      },
      {
        quote: 'Arbitration also creates a natural experiment that facilitates comparison between human and AI adjudicators on dimensions like speed, cost, and participant satisfaction.',
        type: 'context',
      },
    ],
  },
